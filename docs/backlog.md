...
> 구 독립 price-collector 트랙: C-4/C-4-1 OpenAPI+(Windows 전용) 구현(#16 · #27, PR #26 · #32)은
> 도커 리눅스 실행 불가로 **revert**되었고, 키움 REST API 실시간 폴링 수집기로 재구현됨
> (agent-worker 내장 데몬으로 통합 — `docs/price-collector.md`, `docs/spec/kiwoom-rest-spec.md` 참고). 120일 과거 백필은 후속 작업.
