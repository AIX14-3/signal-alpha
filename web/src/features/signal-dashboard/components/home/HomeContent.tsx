...
export function HomeContent({ focusSearch }: { focusSearch?: boolean }) {
  ...
  const featureCards = [
    { icon: 'file-text' as const, title: 'DART Watcher', desc: '전자공시·어닝 서프라이즈 실시간', href: '/dashboard/agents' },
    { icon: 'database' as const, title: 'Report RAG', desc: '증권사 리포트 교차 검증', href: '/dashboard/reports' },
    { icon: 'activity' as const, title: 'Alternative', desc: '채용·특허 선행 지표', href: '/dashboard/stories' },
  ];
  ...
  return (
    <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 items-center px-4 pb-8 pt-10 md:px-8 md:pt-14">
          <div className="animate-fade-in max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/dashboard/features" className="btn-orange rounded-full px-8 py-3.5 text-sm font-bold">
                서비스 알아보기
              </Link>
              <Link
      ...
      <section className="home-dark relative px-4 py-24 text-center md:py-32">
        ...
        <Link href="/dashboard/agents" className="btn-orange mt-10 inline-block rounded-full px-10 py-4 text-sm font-bold">
          에이전트 허브 →
        </Link>
      </section>
