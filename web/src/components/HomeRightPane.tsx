  ...
  return (
    <aside className="flex min-h-0 flex-col gap-4">
      ...
      <div className="glass-card p-4">
        ...
        {/* 종목 뉴스 흐름 한 줄(LLM, display-only). 없으면 블록 생략. 신호 점수와 무관. */}
        {stockNews?.digest?.text && (
          <div className="mb-2 rounded-[10px] bg-surface-2 px-3 py-2">
            <div className="text-[11px] font-semibold text-muted">뉴스 한 줄</div>
            <p className="mt-0.5 text-[12.5px] leading-snug text-navy-soft">
              {stockNews.digest.text}
            </p>
          </div>
        )}
