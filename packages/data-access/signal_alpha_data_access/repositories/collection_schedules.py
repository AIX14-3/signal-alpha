        ...
        *,
        ...
        return await self._connection.fetchrow(
            ...
            SET enabled      = COALESCE($2, enabled),
                ...
                report_limit = COALESCE($8, report_limit),
                report_days_back = COALESCE($9, report_days_back),
                report_max_pages = COALESCE($10, report_max_pages),
                alternative_collect_enabled = COALESCE($11, alternative_collect_enabled),
                alternative_analyze_enabled = COALESCE($12, alternative_analyze_enabled),
                alternative_collect_timeout_seconds = COALESCE($13, alternative_collect_timeout_seconds),
                alternative_analyze_timeout_seconds = COALESCE($14, alternative_analyze_timeout_seconds),
                backpressure_max_waiting = COALESCE($15, backpressure_max_waiting),
                backpressure_max_failed = COALESCE($16, backpressure_max_failed),
                frequency_minutes = COALESCE($17, frequency_minutes),
                active_from_local = COALESCE($18, active_from_local),
                active_until_local = COALESCE($19, active_until_local),
            ...
            backpressure_max_waiting,
            backpressure_max_failed,
            frequency_minutes,
            active_from_local,
            active_until_local,
            updated_by,
