...
\restrict Okh0VN1h0GOqc5TuwmStgFSXIP3usCpJVRPSCAa6Z6kO99MUISXAvUXrddPuaII
...
--
-- Name: user_broker_credentials; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_broker_credentials (
    id bigint NOT NULL,
    user_id bigint NOT NULL,
    broker character varying(10) NOT NULL,
    account_ref character varying(64) DEFAULT ''::character varying NOT NULL,
    ...
    CONSTRAINT chk_broker_cred_broker CHECK (((broker)::text = ANY ((ARRAY['kiwoom'::character varying, 'toss'::character varying])::text[]))),
    CONSTRAINT chk_broker_cred_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'error'::character varying, 'revoked'::character varying])::text[])))
);


--
-- Name: user_broker_credentials_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.user_broker_credentials ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_broker_credentials_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.user_trade_fills (
    ...
    broker character varying(10) NOT NULL,
    account_ref character varying(64) DEFAULT ''::character varying NOT NULL,
    broker_fill_id character varying(80) NOT NULL,
    stock_id bigint,
    ticker character varying(20) NOT NULL,
    ...
    fee numeric(18,4),
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_trade_fill_broker CHECK (((broker)::text = ANY ((ARRAY['kiwoom'::character varying, 'toss'::character varying])::text[]))),
...
--
-- Name: user_broker_credentials uq_broker_cred; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_broker_credentials
    ADD CONSTRAINT uq_broker_cred UNIQUE (user_id, broker, account_ref);
...
--
-- Name: user_trade_fills uq_trade_fill; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_trade_fills
    ADD CONSTRAINT uq_trade_fill UNIQUE (user_id, broker, broker_fill_id);
...
--
-- Name: user_broker_credentials user_broker_credentials_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_broker_credentials
    ADD CONSTRAINT user_broker_credentials_pkey PRIMARY KEY (id);
...
--
-- Name: idx_broker_cred_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_broker_cred_user ON public.user_broker_credentials USING btree (user_id);
...
--
-- Name: idx_trade_fills_user_broker; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_trade_fills_user_broker ON public.user_trade_fills USING btree (user_id, broker, filled_at DESC);
...
--
-- Name: user_broker_credentials trg_broker_cred_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_broker_cred_updated_at BEFORE UPDATE ON public.user_broker_credentials FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
--
-- Name: user_broker_credentials user_broker_credentials_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_broker_credentials
    ADD CONSTRAINT user_broker_credentials_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
\unrestrict Okh0VN1h0GOqc5TuwmStgFSXIP3usCpJVRPSCAa6Z6kO99MUISXAvUXrddPuaII
